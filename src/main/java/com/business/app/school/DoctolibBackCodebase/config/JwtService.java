...
//can move to other package

/**
 * This class take capability of jsonwebtoken library to manipulate Jwt Token
 * In this project, this class provide to other classes extraction of username, information about expiration of token, and checking if userDetails and token contains the same username
 * N.B. Username in the context of this application is the user email
 *
